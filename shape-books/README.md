...
1. Create a new project and select the "Shape Books" template
1. `git clone https://github.com/takeshape/takeshape-samples takeshape-samples && cd takeshape-samples/shape-books`
